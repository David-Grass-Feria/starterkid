<div class="mb-5">
    ...
    <div class="flex rounded-md shadow-sm">
      ...
      <input {{$attributes->merge(['class' => 'block w-full min-w-0 flex-1 rounded-none rounded-r-md border-0 py-1.5 text-font_primary ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6'])}}>
