...
@can('update',\GrassFeria\StarterkidSetting\Models\Setting::class)
...
<x-starterkid::starterkid.nav-link href="{{route('users.index')}}" :active="request()->routeIs(['users.index','users.edit','users.create'])">
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5" viewBox="0 0 16 16">
